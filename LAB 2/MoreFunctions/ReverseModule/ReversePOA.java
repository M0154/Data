 ...
 implements ReverseModule.ReverseOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("to_upper", new java.lang.Integer (1));
    _methods.put ("to_lower", new java.lang.Integer (2));
    _methods.put ("capitalize", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // ReverseModule/Reverse/to_upper
       {
         String str = in.read_string ();
         String $result = null;
         $result = this.to_upper (str);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 2:  // ReverseModule/Reverse/to_lower
       {
         String str = in.read_string ();
         String $result = null;
         $result = this.to_lower (str);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 3:  // ReverseModule/Reverse/capitalize
       {
         String str = in.read_string ();
         String $result = null;
         $result = this.capitalize (str);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
